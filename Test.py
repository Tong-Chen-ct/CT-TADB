...
x_test = np.load('GM12878_manually_encoded_data-1.npy')
y_test = np.load('GM12878_manually_encoded_labels-1.npy')
bed_files_test_anchors1 = ['GM12878_TAD_boundaries_positive_10kb-1.bed', 'GM12878_TAD_boundaries_negative_10kb-1.bed']
...
def two_CNN_Transformer(x_test, y_test,histone_test,learning_rate, INPUT_SHAPE, KERNEL_SIZE, NUM_KERNEL, transformer_dim, num_heads, name):
...
#    #x = MaxPooling1D()(x)   
    ...
    filepath = "GM12878_0.001_9_64_32_4_64_CNN_Transformer_DNA_12histone.hdf5"
...
model = two_CNN_Transformer(x_test, y_test,histone_test,learning_rate,input_shape, kernel_size, num_kernels, transformer_dim, num_heads, name)
